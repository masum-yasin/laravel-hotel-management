							...
							<div class="card-body p-4">
								...
								<form class="row g-3" method="POST" action="{{route('store.blog.post')}}" enctype="multipart/form-data">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control" id="input2" name="post_title">
									</div>
									<div class="col-md-12">
										<label for="input11" class="form-label">Short Descriptaion</label>
										<textarea class="form-control" id="input11" rows="3" name="short_descp"></textarea>
									</div>
									<div class="col-md-12">
										<label for="input11" class="form-label">Long Descriptaion</label>
										<textarea class="form-control" id="editor"  rows="3" name="long_descp"></textarea>
									</div>
									<div class="col-md-4">
