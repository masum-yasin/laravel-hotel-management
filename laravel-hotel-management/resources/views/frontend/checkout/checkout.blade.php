            ...
            <form method="post" role="form" action="{{route('checkout.store')}}">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                  <div class="billing-details">
                                        ...
                                        <table class="table" style="width: 100%">
                                            @php
                                                $subtotal = $room->price * $nights * $book_data['roomNumber'];
                                            ...
                                            @endphp
                                              ...
                                              <tr>
                                                    ...
                                                    <td style="text-align: right"><p>{{$book_data['roomNumber']}}</p></td>
                                              </tr>
                                              <tr>
                                                    <td><p>Subtotal</p></td>
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="payment-box" style="margin-top:10px !important;">
                            <div class="payment-method">
                                ...
                                <p>
                                    <input type="radio" id="paypal" name="payment_method" value="Stripe">
